...
$query 		= "SELECT T1.*, (SELECT MAX(G.CAT_DTL_CONT_SIZE) FROM TX_YARD_PLAN_GROUP E
				...
				FROM (
					SELECT A.YBC_YARD_ID ,A.YBC_CELL_ID, B.BLOCK_ID, B.BLOCK_NAME, B.BLOCK_POSITION, B.BLOCK_ORIENTATION, B.BLOCK_TIER, A.YBC_ROW, A.YBC_SLOT, B.BLOCK_ROW MAX_ROW, B.BLOCK_SLOT MAX_SLOT, A.YBC_BRANCH_ID,
...
$xml_str = "<yard>".$width_str.$height_str.$stack_str.$plan_str.$taken_str.$placement_str.$slot_str.$max_slot_str.$row_str.$max_row_str.$tier_str.$title_str.$block_id_str.$orientation_str.$position_str.$label_str.$label_text_str.$ybc_id_str.$cont_size_str.$label_block_dummy.$cont_size_real_str."</yard>";
//die(var_dump($xml_str));
return $xml_str;
}
