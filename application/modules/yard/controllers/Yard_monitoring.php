...
class Yard_monitoring extends CI_Controller {
  ...
  public function index(){
    ...
    //die();
      ...
      //print_r(explode(",", $data_yard->cont_size_real)); die();
    ...
    public function get_yard_stacking($id_yard, $block, $id_slot,$ybc_id){
      ...
      $block_select = $this->m_yard->get_block_select($id_yard, $block);
      ...
      foreach($raw_data as $datavalue){
          $cy_data[$datavalue['YBC_SLOT']][] = array(
              'BLOCK_NAME' => $datavalue['BLOCK_NAME'],
              'SLOT' => $datavalue['YBC_SLOT'],
              ...
              'HAZARD' => '',
              'DELIVERY_TO' => $datavalue['DELIVERY_TO'],
              'CONT_OWNER' => $datavalue['OWNER_NAME']
          );
