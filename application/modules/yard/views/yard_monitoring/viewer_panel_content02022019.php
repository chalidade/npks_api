                     ...
                     //if($cont_size_real[$p] == 40 ){echo "fourtyfeet "; }
                      ...
                      if($block_dummy[$p] == 'N'){
                        ...
                        echo "dummy";
									...
									?> <?php if($cont_size[$p] == 40 && $placement[$p] != 1) {echo 'fourtyfeet_background'; } ?>"
...
$(".exist").on('click', function(event){
      ...
      for(var y =0;y<resData.data_idx.length;y++){
          ...
          for(var j=Number(resData.configs.MAX_TIER);j>=1;j--){
              ...
              for(var k=1;k<=Number(resData.configs.MAX_ROW);k++){
                  bodyContent += "<td data-row='" +k+ "' data-tier='" +j+ "' class='data CellWithComment'></td>";
              }
  ...
  if(Globals.getSocketYardMon() == 0){
    ...
    function tierMonitoring(branch, ybc_id, tier, cont, loc, ybc_id40, size, ybc_id_old, ybc_id_old40, tier_old, tier_old40){
