            ...
            $labelVariable = array();
              ...
              ?>
								<div class="<?php
										...
										echo "div_cell_block_".$tab_id." ". $placement[$p] ." cont_size_$cont_size[$p] ";
                      ...
                      if($block_dummy[$p] == 'N'){
                        ...
                        echo "dummy";
								...
								>
                <div <?php if($cont_size_real[$p] == 40 ){echo 'class="fourtyfeet"'; }?> ></div>
								</div>
                        <?php
								$p++;
							}
  ...
  Ext.Ajax.request({
        ...
        success: function(response, request){
          ...
          failure: function(response, request){
              myMask.hide();
              Ext.MessageBox.alert('Connection Error, mohon coba lagi..');
