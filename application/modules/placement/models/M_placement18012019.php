	  ...
	  if($size == 40){
		...
		if($activity == 3){
			...
			if($_POST['DATE_PLACEMENT'] != 0){
					...
					$insertGATEIN = "INSERT INTO TX_GATE (GATE_NOREQ, GATE_CONT,GATE_CONT_STATUS, GATE_CONT_SIZE, GATE_CONT_TYPE, GATE_TRUCK_NO, GATE_ORIGIN, GATE_CREATE_DATE, GATE_STATUS, GATE_ACTIVITY, GATE_STACK_STATUS, GATE_FL_SEND, GATE_BRANCH_ID, GATE_ACTIVE) VALUES
											 ('".$req_id."','".$cont."','".$cont_status."','".$size."','".$type."','PELINDO','".$origin."', TO_DATE('".$date_placement_tpk."','MM/DD/YYYY HH24:MI'),'3', '3','2', '9', ".$branch_id." , 'T')";
					$resultHDR = $this->db->query($insertGATEIN);
				}
				else{
					$insertGATEIN = "INSERT INTO TX_GATE (GATE_NOREQ, GATE_CONT, GATE_CONT_STATUS, GATE_CONT_SIZE, GATE_CONT_TYPE, GATE_TRUCK_NO, GATE_ORIGIN, GATE_CREATE_DATE, GATE_STATUS, GATE_ACTIVITY, GATE_STACK_STATUS, GATE_FL_SEND, GATE_BRANCH_ID, GATE_ACTIVE) VALUES
											 ('".$req_id."','".$cont."','".$cont_status."','".$size."','".$type."','PELINDO','".$origin."', TO_DATE('".$gate_date_tpk."','MM/DD/YYYY HH24:MI:SS'),'1', '3','1', '9', ".$branch_id.", 'T')";
					$resultHDR = $this->db->query($insertGATEIN);

					$insertGATEIN = "INSERT INTO TX_GATE (GATE_NOREQ, GATE_CONT,GATE_CONT_STATUS, GATE_CONT_SIZE, GATE_CONT_TYPE, GATE_TRUCK_NO, GATE_ORIGIN, GATE_CREATE_DATE, GATE_STATUS, GATE_ACTIVITY, GATE_STACK_STATUS, GATE_FL_SEND, GATE_BRANCH_ID, GATE_ACTIVE) VALUES
											 ('".$req_id."','".$cont."','".$cont_status."','".$size."','".$type."','PELINDO','".$origin."', TO_DATE('".$gate_date_tpk."','MM/DD/YYYY HH24:MI:SS'),'3', '3','2', '9', ".$branch_id." , 'T')";
					$resultHDR = $this->db->query($insertGATEIN);
				}
