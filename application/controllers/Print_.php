...
class Print_ extends CI_Controller {
    ...
    //rite some HTML code:
		$header = '<img src="'.DIR.'/../assets/logo.png" width="100" height="40" style=" margin-left:-50px; margin-top:-20px;">';
		$header .= '<div style="margin-left:-51px;margin-right:-45px; margin-top:-10px"><hr></div>';
