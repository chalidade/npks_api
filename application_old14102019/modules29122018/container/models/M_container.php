...
class M_container extends CI_Model {
	...
	public function get_data_container_inquiry($filter){
		...
		$sql = "
			SELECT A.HIST_CONT, CASE WHEN A.HIST_SLOT_EXT IS NOT NULL THEN (A.HIST_SLOT || ' - ' || A.HIST_SLOT_EXT) ELSE A.HIST_SLOT END HIST_SLOT, NVL(A.HIST_ROW,'-') HIST_ROW, NVL(A.HIST_TIER,'-') HIST_TIER, NVL(A.HIST_BLOCK,'-') HIST_BLOCK, NVL(A.HIST_YARD,'-') HIST_YARD,
			A.HIST_ACTIVITY, A.HIST_CONT_STATUS, A.HIST_COUNTER, B.CONTAINER_SIZE CONTAINER_SIZE, NVL(A.HIST_SLOT_EXT,'-') HIST_SLOT_EXT
	...
	public function get_data_container_history($filter){
		...
		$sql = "
			SELECT
				...
				CASE WHEN HIST_SLOT_EXT IS NOT NULL THEN (HIST_SLOT || ' - ' || HIST_SLOT_EXT) ELSE HIST_SLOT END HIST_SLOT,
				...
				HIST_CONT_STATUS,
				NVL(HIST_SLOT_EXT,'-') HIST_SLOT_EXT
			FROM TH_HISTORY_CONTAINER
