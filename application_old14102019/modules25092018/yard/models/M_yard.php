...
//END
	...
	public function reportYorExport(){
		...
		$z = 0;
		$tot_rec_mty_20 = array();
		$tot_rec_mty_40 = array();
		$tot_rec_fl_20 = array();
		$tot_rec_fl_40 = array();
		$tot_box_rec = array();
		$tot_teus_rec = array();
		...
		foreach ($arrData as $key => $value) {
			$arrData2[$key] = $value;
			//total
			$tot_rec_mty_20[$z] = $value['YOR_REC_MTY20'];
			$tot_rec_mty_40[$z] = $value['YOR_REC_MTY40'];
			$tot_rec_fl_20[$z] = $value['YOR_REC_FCL20'];
			$tot_rec_fl_40[$z] = $value['YOR_REC_FCL40'];
		...
		$tot_rec_mty_20 = array_sum($tot_rec_mty_20);
		$tot_rec_mty_40 = array_sum($tot_rec_mty_40);
		$tot_rec_fl_20 = array_sum($tot_rec_fl_20);
		$tot_rec_fl_40 = array_sum($tot_rec_fl_40);
		...
		$arrTotal = array();
		$arrTotal['tot_rec_mty_20'] = $tot_rec_mty_20;
		$arrTotal['tot_rec_mty_40'] = $tot_rec_mty_40;
		$arrTotal['tot_rec_fl_20'] = $tot_rec_fl_20;
		$arrTotal['tot_rec_fl_40'] =$tot_rec_fl_40;
		...
		$arrAvg['avg_rec_mty_20'] = round($tot_rec_mty_20/$count,2);
		$arrAvg['avg_rec_mty_40'] = round($tot_rec_mty_40/$count,2);
		$arrAvg['avg_rec_fl_20'] = round($tot_rec_fl_20/$count,2);
		$arrAvg['avg_rec_fl_40'] = round($tot_rec_fl_40/$count,2);
