  ...
  function getReport(){
		...
		//apply filter
			...
			$query = "SELECT F.* FROM (SELECT T.*, ROWNUM r FROM (SELECT * FROM(
              SELECT A.REAL_STUFF_CONT CONT, C.STUFF_DTL_CONT_SIZE SIZE_, C.STUFF_DTL_CONT_TYPE TYPE_, A.REAL_STUFF_NOREQ REQ, TO_CHAR(B.STUFF_CREATE_DATE,'DD/MM/YYYY HH24:MI:SS') TGL_REQ, TO_CHAR(A.REAL_STUFF_DATE,'DD/MM/YYYY HH24:MI:SS') AS STARTNYA,
              TO_CHAR((SELECT REAL_STUFF_DATE FROM TX_REAL_STUFF WHERE REAL_STUFF_CONT = A.REAL_STUFF_CONT AND REAL_STUFF_NOREQ = A.REAL_STUFF_NOREQ AND REAL_STUFF_STATUS = 2 ),'DD/MM/YYYY HH24:MI:SS') ENDNYA,
              CASE WHEN ROUND(((SELECT REAL_STUFF_DATE FROM TX_REAL_STUFF WHERE REAL_STUFF_CONT = A.REAL_STUFF_CONT AND REAL_STUFF_NOREQ = A.REAL_STUFF_NOREQ AND REAL_STUFF_STATUS = 2 ) - A.REAL_STUFF_DATE),2) < 1 THEN 1 ELSE
							ROUND(((SELECT REAL_STUFF_DATE FROM TX_REAL_STUFF WHERE REAL_STUFF_CONT = A.REAL_STUFF_CONT AND REAL_STUFF_NOREQ = A.REAL_STUFF_NOREQ AND REAL_STUFF_STATUS = 2 ) - A.REAL_STUFF_DATE),2) END DURASI,
              ...
              SELECT A.REAL_STRIP_CONT CONT, C.STRIP_DTL_CONT_SIZE SIZE_, C.STRIP_DTL_CONT_TYPE TYPE_, A.REAL_STRIP_NOREQ REQ, TO_CHAR(B.STRIP_CREATE_DATE,'DD/MM/YYYY HH24:MI:SS') TGL_REQ, TO_CHAR(A.REAL_STRIP_DATE,'DD/MM/YYYY HH24:MI:SS') AS STARTNYA,
              TO_CHAR((SELECT REAL_STRIP_DATE FROM TX_REAL_STRIP WHERE REAL_STRIP_CONT = A.REAL_STRIP_CONT AND REAL_STRIP_NOREQ = A.REAL_STRIP_NOREQ AND REAL_STRIP_STATUS = 2 ),'DD/MM/YYYY HH24:MI:SS') ENDNYA,
              CASE WHEN ROUND(((SELECT REAL_STRIP_DATE FROM TX_REAL_STRIP WHERE REAL_STRIP_CONT = A.REAL_STRIP_CONT AND REAL_STRIP_NOREQ = A.REAL_STRIP_NOREQ AND REAL_STRIP_STATUS = 2 ) - A.REAL_STRIP_DATE),2) < 1 THEN 1 ELSE
							ROUND(((SELECT REAL_STRIP_DATE FROM TX_REAL_STRIP WHERE REAL_STRIP_CONT = A.REAL_STRIP_CONT AND REAL_STRIP_NOREQ = A.REAL_STRIP_NOREQ AND REAL_STRIP_STATUS = 2 ) - A.REAL_STRIP_DATE),2) END DURASI,
