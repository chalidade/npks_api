...
<html lang="en" dir="ltr">
  ...
  <body>
    <table style="margin-left:-40;" class="tz2">
      <tr>
        <td colspan="25"><img src="<?=DIR?>/../assets/logo.png" width="130" height="60"></td>
      </tr>
      <tr>
          <td colspan="25" style="width:80%; text-align:center;">LAPORAN POSISI PETIKEMAS</td>
      </tr>
      <tr>
          <td colspan="25" style="width:80%; text-align:center;"><?=$date2?></td>
      </tr>
    </table>
    <table class="tz">
      <tr>
    ...
    <table class="tg">
      <tr>
          ...
          <th class="tg-hyn2" colspan="10">RECEIVING</th>
          <th class="tg-hyn2" colspan="10">DELIVERY</th>
        ...
        <tr>
          ...
          <td class="tg-hyn2" colspan="4">LUAR<br></td>
          <td class="tg-hyn2" colspan="2">JUMLAH</td>
          <td class="tg-hyn2" colspan="4">TPK</td>
          <td class="tg-hyn2" colspan="4">KELUAR</td>
          <td class="tg-hyn2" colspan="2">JUMLAH</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="tg-h4ka">O25</td>
          <td class="tg-h4ka">O26</td>
          <td class="tg-h4ka">O27</td>
          <td class="tg-h4ka">O28</td>
        </tr>
      <?php foreach ($data['DATA'] as $val) { ?>
      <tr>
        <td class="tg-xocx"><?=$val['YOR_DATE2']?></td>
        <td class="tg-xocx"><?=$val['YOR_REC_TPK_FCL20']?></td>
        <td class="tg-xocx"><?=$val['YOR_REC_TPK_FCL40']?></td>
        <td class="tg-xocx"><?=$val['YOR_REC_TPK_MTY20']?></td>
        <td class="tg-xocx"><?=$val['YOR_REC_TPK_MTY40']?></td>

        <td class="tg-xocx"><?=$val['YOR_REC_DEPO_FCL20']?></td>
        <td class="tg-xocx"><?=$val['YOR_REC_DEPO_FCL40']?></td>
        <td class="tg-xocx"><?=$val['YOR_REC_DEPO_MTY20']?></td>
        <td class="tg-xocx"><?=$val['YOR_REC_DEPO_MTY40']?></td>
        ...
        <td class="tg-xocx"><?=$val['YOR_BOX']?></td>
        <td class="tg-xocx"><?=$val['YOR_TEUS']?></td>
        <td class="tg-xocx"><?=$val['YOR_TOTAL']?></td>
        <td class="tg-xocx"><?=$val['YTP_TOTAL']?></td>
      </tr>
        <?php } ?>
        <tr>
          <td class="tg-hyn2">Jumlah</td>
          <td class="tg-xocx"><?=$data['TOTAL']['tot_rec_tpk_fl_20']?></td>
          <td class="tg-xocx"><?=$data['TOTAL']['tot_rec_tpk_fl_40']?></td>
          <td class="tg-xocx"><?=$data['TOTAL']['tot_rec_tpk_mty_20']?></td>
          <td class="tg-xocx"><?=$data['TOTAL']['tot_rec_tpk_mty_40']?></td>

          <td class="tg-xocx"><?=$data['TOTAL']['tot_rec_depo_fl_20']?></td>
          <td class="tg-xocx"><?=$data['TOTAL']['tot_rec_depo_fl_40']?></td>
          <td class="tg-xocx"><?=$data['TOTAL']['tot_rec_depo_mty_20']?></td>
          <td class="tg-xocx"><?=$data['TOTAL']['tot_rec_depo_mty_40']?></td>
        ...
        <tr>
          ...
          <td class="tg-xocx"><?=$data['AVG']['avg_rec_tpk_fl_20']?></td>
          <td class="tg-xocx"><?=$data['AVG']['avg_rec_tpk_fl_40']?></td>
          <td class="tg-xocx"><?=$data['AVG']['avg_rec_tpk_mty_20']?></td>
          <td class="tg-xocx"><?=$data['AVG']['avg_rec_tpk_mty_40']?></td>

          <td class="tg-xocx"><?=$data['AVG']['avg_rec_depo_fl_20']?></td>
          <td class="tg-xocx"><?=$data['AVG']['avg_rec_depo_fl_40']?></td>
          <td class="tg-xocx"><?=$data['AVG']['avg_rec_depo_mty_20']?></td>
          <td class="tg-xocx"><?=$data['AVG']['avg_rec_depo_mty_40']?></td>
