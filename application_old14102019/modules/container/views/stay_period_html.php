...
<html lang="en" dir="ltr">
  ...
  <body>
    <table style="margin-left:-40;">
      ...
      <tr>
        <td colspan="10" style="width:80%; text-align:center;"><div class="header">Stay Period Container</div></td>
      </tr>
    </table>
    <table class="tz">
      <tr>
        <td colspan="10" style="text-align:left; font-weight:bold">Cabang : <?php echo $branch ?></td>
      </tr>
    </table>
  ...
  <tr>
    ...
    <td class="tg-hgcj" width="70">Status</td>
    <td class="tg-hgcj" width="110">Location</td>
    <td class="tg-hgcj" width="70">Activity</td>
    <td class="tg-hgcj" width="110">Start Stack</td>
    <td class="tg-hgcj" width="70">Stacking Duration</td>
