...
class Client extends CI_Controller {
	...
	function generateSetGateIn($branch = false){
    	...
    	$sqlgetIn = "SELECT GATE_ID, GATE_CONT AS NO_CONTAINER, GATE_NOREQ AS NO_REQUEST, GATE_TRUCK_NO AS NOPOL, GATE_CREATE_BY AS ID_USER, TO_CHAR(GATE_CREATE_DATE,'MM/DD/YYYY HH24:MI:SS') AS TGL_IN, GATE_CONT_STATUS AS STATUS, GATE_ORIGIN FROM TX_GATE  WHERE GATE_FL_SEND = '0' AND GATE_ACTIVITY = '3' AND GATE_STATUS = '1' AND GATE_BRANCH_ID = ".$branch." AND GATE_CONT = 'BSIU3185693' ORDER BY GATE_CREATE_DATE ASC";
