...
class StuffingStrippingReport extends CI_Controller {

  private $secret = 'this is key secret';

  public function __construct(){
		parent::__construct();
		$this->load->model('m_stuffingstrippingreport');
  ...
  public function index(){
    $data = $this->m_stuffingstrippingreport->getReport();
  ...
  public function reportExport(){
    ...
    $activity = $this->m_stuffingstrippingreport->getReportActivity($_GET['activity']);
    ...
    $data['date1'] = $date1;
    $data['date2'] = $date2;
    $name = 'Report_Stuffing_Stripping_'.$date1.'-'.$date2;
    $data['data'] = $this->m_stuffingstrippingreport->getStuffStrippExport();
    // print_r($data); die();
    $html = $this->load->view('stuffstrip/pdf',$data,true);
    //rite some HTML code:
  ...
  public function reportExcel(){
    ...
    $data['data'] = $this->m_stuffingstrippingreport->getStuffStrippExport();
    // print_r($data); die();
    $html = $this->load->view('stuffstrip/excel',$data,true);
