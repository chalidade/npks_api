...
.tier1{ background: #00d672; }
.tier2{ background: #4885ed; }
.tier3{ background: #f4c20d; }
.tier4{ background: #f492a5; }
/* .tier5{ background: #db3236; } */
.tier5{ background: #ef3235; }
/* .tier6{ background: #e55934; } */
.tier6{ background: #63223c; }
              ...
              ?>
                      ...
                      if($block_dummy[$p] == 'N'){
                        ...
                        echo "dummy";
								...
								>
                <div <?php if($cont_size[$p] == 40) {echo 'class="fourtyfeet"'; }?> ></div>
								</div>
                        <?php
								$p++;
							}
...
$(".exist").on('click', function(event){
  ...
  function generateDataContainer(dataContainer){
      ...
      var data = header + '<br />'+dtl+ '<span class="CellComment">No Container : '+cont+'<br> Size : '+size+'<br> Type : '+type+'<br> Status : '+status+'</span>';
      return data;
  }
