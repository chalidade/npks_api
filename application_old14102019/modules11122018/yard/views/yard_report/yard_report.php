      ...
      <table class="tg">
        ...
        for ($y=1; $y <= $block_data['MAX_TIER'] ; $y++) {
          ...
          <tr>
            ...
            <td class="tg-s6z2"><?=isset($REAL_YARD_CONT)?></td>
            <td class="tg-s6z2"><?=isset($REAL_YARD_CONT_SIZE)?></td>
            <td class="tg-s6z2"><?=isset($REAL_YARD_CONT_TYPE)?></td>
            <td class="tg-s6z2"><?=isset($REAL_YARD_CONT_STATUS)?></td>
            <?php if($y == 1){ ?>
