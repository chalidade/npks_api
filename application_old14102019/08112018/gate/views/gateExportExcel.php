...
<html lang="en" dir="ltr">
  ...
  <body>
    <table style="margin-left:-40;">
      <tr>
        <td colspan="11"><img src="<?=DIR?>/../assets/logo.png" width="130" height="60"></td>
      </tr>
      <tr>
          <td colspan="11" style="width:80%; text-align:center;"><div class="header">GATE REPORT</div></td>
      </tr>
    </table>
    <table class="tz">
      <tr>
  ...
  <tr>
    ...
    <td class="tg-hgcj">Request Date<br></td>
    <td class="tg-hgcj">Container No</td>
    <td class="tg-hgcj">Container Owner</td>
