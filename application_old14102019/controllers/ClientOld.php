...
class ClientOld extends CI_Controller {
	...
	function callEsb(){
		$client = "http://10.88.48.33/npks-api/index.php/Server";//alamat web service
		$method = 'testEsb'; //method
		$arr ['name'] ='Bobi Hariadi';
		$arr ['address'] ='Jakarta Selatan';
		$arr ['phone'] ='081374336102';
		$arr ['age'] ='28';

		$arr ['func'] ='testSample';
		

		$jsonParam = json_encode($arr);
		// echo $jsonParam;die();
        $params = array('params'=>$jsonParam);

		$response = $this->call_service($client, $method,$params);
		echo $response."<br>";

		$res = json_decode($response, true);
		$resParams = $res['params'];
		
		$resData = json_decode($resParams, true);
		echo $resData['Name']."<br>";
		echo $resData['Address']."<br>";
		echo $resData['Phone']."<br>";
		echo $resData['Age']."<br>";

		echo $resData['Function'];
	}
