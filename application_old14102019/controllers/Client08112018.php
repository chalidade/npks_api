...
class Client extends CI_Controller {
    ...
    function getBatalMuat(){
        ...
        $sqlLastDateNota = "select TGL from (
                            select TO_CHAR(CANCELLED_CREATE_DATE,'YYYYMMDDHH24MISS') TGL from  TH_CANCELLED  WHERE CANCELLED_STATUS IN (1,2,3,4,5,6) AND CANCELLED_BRANCH_ID = 3  order by CANCELLED_CREATE_DATE DESC
                            )A where rownum =1";
    ...
    function getBatalStuffStrip(){
        ...
        $sqlLastDateNota = "select TGL from (
                            select TO_CHAR(CANCELLED_CREATE_DATE,'YYYYMMDDHH24MISS') TGL from  TH_CANCELLED  WHERE CANCELLED_STATUS IN (7,8) AND CANCELLED_BRANCH_ID = 3  order by CANCELLED_CREATE_DATE DESC
                            )A where rownum =1";
    ...
    function getBatalOperation(){
        ...
        $sqlLastDateNota = "select TGL from (
                            select TO_CHAR(CANCELLED_CREATE_DATE,'YYYYMMDDHH24MISS') TGL from  TH_CANCELLED  WHERE CANCELLED_STATUS IN (9,19,11,12,13,14,15) AND CANCELLED_BRANCH_ID = 3  order by CANCELLED_CREATE_DATE DESC
                            )A where rownum =1";
