...
class M_dashboard extends CI_Model {
	...
	public function getDataStuffing(){
		...
		WHERE A.STUFF_BRANCH_ID = $branch_id AND  A.STUFF_STATUS <> '2' AND B.STUFF_DTL_ACTIVE = 'Y') Z)";
		$data = $this->db->query($sql)->result();
		return $data;
	}
	...
	public function getDataStripping(){
		...
		WHERE A.STRIP_BRANCH_ID = $branch_id AND A.STRIP_STATUS <> 2 AND B.STRIP_DTL_ACTIVE = 'Y') Z)";
		$data = $this->db->query($sql)->result();
		return $data;
	}
