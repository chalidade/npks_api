...
//END
	...
	public function reportYor(){
		...
		$data = $this->db->where('YOR_BRANCH_ID',$branch_id)->where("to_char(YOR_DATE,'MMYYYY')","'$date2'",false)->where('YOR_YARD_ID',$yard)->order_by("TO_CHAR(YOR_DATE,'YYYYMMDD')")->get('TH_REPORT_YOR')->result_array();
