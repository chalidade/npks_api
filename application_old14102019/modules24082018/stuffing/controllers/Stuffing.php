...
class Stuffing extends CI_Controller {
  ...
  public function getContainer(){
    $data = $this->m_stuffing->getContainer();
  ...
  public function getContainerById(){
    if($id = $this->check_token()){
      if($id == $this->session->userdata('isId')){
        $return = $this->m_stuffing->getContainerById();
      }
      else{
        $return = array(
          'success' => false,
  ...
  public function cekStuffingRun(){
    $return = $this->m_stuffing->cekStuffingRun();
  ...
  public function insertStuffing(){
    if($id = $this->check_token()){
      if($id == $this->session->userdata('isId')){
        $data = $this->m_stuffing->setStuffing();
        $return = array(
          'success' => true,
          'message' => $data
        );
